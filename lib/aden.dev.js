    ...
    this.loadPages(this.rootConfig)
      ...
      .then(({ pages }) => {
        ...
        try {
          this.compiler = webpack(
            Object.keys(this.webpackConfigs)
              .map((k) => this.webpackConfigs[k])
          );
      ...
      .then(() => {
        this.logger.info('Done handling changes', {
          frontendEntry: this.webpackConfigs.frontend.entry,
          BackendEntry: this.webpackConfigs.backend.entry,
        });
      })
      .catch((err) => {
