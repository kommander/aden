...
function AdenBackend(...args) {
  ...
  const originalListen = this.server.listen
  ...
  this.server.listen = (...params) => {
    ...
    this.server.on('request', (req, res) => {
      console.log('SERVER REQUEST HANDLER')
      handler(req, res)
    })
    console.log('listening')
    originalListen.call(this.server, ...params)
  }
...
AdenBackend.prototype.runMiddlewares = async function runMiddlewares (req, res) {
...
AdenBackend.prototype.getRequestHandler = function getRequestHandler() {
  return this.requestHandler.bind(this)
}

AdenBackend.prototype.requestHandler = function requestHandler(req, res) {
