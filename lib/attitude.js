...
class Attitude {
  constructor (aden, name, location) {
    ...
    this.checkAccessMulti = checkAccessMulti
    this.loadNativeOrJSON = loadNativeOrJSON

    _.extend(this, _.pick(aden, [
      'name', 'version', 'rootPath',
      'isDEV', 'settings', 'flattenPages',
      'supportedMethods', 'applyPagePathsToConfig'
    ]))
  }
...
['hook', 'registerPage', 'loadWrappedFn', 'getPage', 'loadPage']
  .forEach((methodName) => Object.assign(Attitude.prototype, {
    [methodName]: function (...args) { return this.aden[methodName](...args) }
  }))
