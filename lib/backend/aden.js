...
const AdenNPM = require('./aden.npm.js');
...
function AdenBackend(app, logger, rootConfig) {
  const rootPage = {
    path: './',
    pagesPath: './',
    basePath: '/',
    ...
    ignore: [
      ...
      /lib/, /reducers/, /node_modules/,
      /bower_components/, /coverage/, /test/, /tests/,
      /dist/, /dev/,
  ...
  this.logger = logger.namespace(this.name, {
...
AdenBackend.prototype.installPage = AdenNPM.installPage;
AdenBackend.prototype.runNpm = AdenNPM.runNpm;
