          ...
          args.page.keys
            ...
            .forEach((key) => {
              ...
              const htmlPluginForKey = (pluginKey, pageScope) => {
                ...
                if (pluginKey.entry === ENTRY_TYPE_STATIC
                  && pluginKey.value.match(/index\.html?/)) {
                  Object.assign(pageScope.key.staticMain, {
                    value: pluginKey.name,
                  });
                }
            ...
            .then((hooked) => {
              ...
              if (typeof hooked.page.key.webpack.value === 'object') {
                Object.assign(frontendConfig,
                  webpackMerge(frontendConfig, hooked.page.key.webpack.value));
              }
