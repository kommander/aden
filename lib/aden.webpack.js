...
function generateWebpackConfig(loadedPages) {
          ...
          webpackConfigs.forEach((webpackConfig) => _.merge(webpackConfig, {
            ...
            module: {
              loaders: webpackConfig.module.loaders.concat(page.loaders.map((loader) => {
                const excludes = !Array.isArray(loader.exclude)
                  ? [loader.exclude]
                  : loader.exclude;
                ...
                return Object.assign(loader, {
                  ...
                  exclude: excludes.concat([
                    // exclude default pages from app level loaders
  ...
  .then(({ pages, webpackConfigs /* , paths */ }) => {
    ...
    if (webpackConfigs[0].globalChunks.length > 0) {
      orderedPlugins.push(
        new webpack.optimize.CommonsChunkPlugin({
          name: 'global',
          filename: 'global.js',
          chunks: webpackConfigs[0].globalChunks,
          minChunks: 1,
        })
      );
    }
  ...
  return Promise.resolve().then(() => {
    ...
    if (this.compilerIsRunning !== true) {
      ...
      return new Promise((resolve, reject) => this.compiler.run((err, stats) => {
        ...
        // TODO: handle multi stats errors/warnings correctly
        ...
        this.logger.success('Webpack done.', null, stats);
