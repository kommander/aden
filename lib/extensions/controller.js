...
module.exports = (aden) => {
  ...
  aden.registerFile('getPath', /\.get\.jsx?$/, { key: { build: false } });
  aden.registerFile('postPath', /\.post\.jsx?$/, { key: { build: false } });
  aden.registerFile('putPath', /\.put\.jsx?$/, { key: { build: false } });
  aden.registerFile('deletePath', /\.delete\.jsx?$/, { key: { build: false } });
